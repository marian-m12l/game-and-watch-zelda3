...
raw_data = read_file("scripts/zelda_assets_in_intflash.dat")
write_c_array("Core/Src/porting/zelda_assets_in_intflash", "zelda_intflash_assets", raw_data)

raw_data = read_file("scripts/zelda_assets_in_ram.dat")
write_c_array("Core/Src/porting/zelda_assets_in_ram", "zelda_ram_assets", raw_data)

raw_data = read_file("scripts/zelda_assets_in_extflash.dat")
write_c_array("Core/Src/porting/zelda_assets_in_extflash", "zelda_extflash_assets", raw_data)
