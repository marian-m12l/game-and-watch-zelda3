...
assets_location = [
        ...
        (72,    'ram'),          # Font Data                     (4096 B)
        (82,    'intflash'),     # Palette Dungeon BG Main       (3600 B)
        (83,    'intflash'),     # Palette Sprites Main          (240 B)
        (84,    'intflash'),     # Palette Armor and Gloves      (150 B)
        (85,    'intflash'),     # Palette Sword                 (24 B)
        (86,    'intflash'),     # Palette Shield                (24 B)
        (87,    'intflash'),     # Palette Sprites Aux 3         (168 B)
        (88,    'intflash'),     # Palette Misc Sprites Indoor   (154 B)
        (89,    'intflash'),     # Palette Sprites Aux 1         (336 B)
        (90,    'intflash'),     # Palette Overworld BG Main     (420 B)
        (91,    'intflash'),     # Palette Overworld BG Aux 1/2  (840 B)
        (92,    'intflash'),     # Palette Overworld BG Aux 3    (196 B)
        (93,    'intflash'),     # Palette Palace Map BG         (192 B)
        (94,    'intflash'),     # Palette Palace Map Sprites    (42 B)
        (95,    'intflash'),     # Palette Hud                   (128 B)
